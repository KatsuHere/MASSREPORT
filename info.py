...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7249254328:AAEyYJNwG1c_hSC7NiQAXS1M9Aq5lO_gt8g") # ⚠️ Required
    
    # Other Configs
    BOT_START_TIME = time.time()
    OWNER    = int(os.environ.get("OWNER", "7494727691"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "7494727691").split()))  # ⚠️ Required
    # Web Response Config
